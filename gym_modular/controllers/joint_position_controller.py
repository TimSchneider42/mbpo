...
class JointPositionController(RobotComponentController):
    ...
    def __init__(self, robot_name: str, robot_component: str,
    ...
    @classmethod
    def from_parameters(cls, robot_name: str, robot_component: str,
        ...
        """
        pos_limits_lower = np.array(parameters["joint_position_limits_lower"])
        pos_limits_upper = np.array(parameters["joint_position_limits_upper"])
        return JointPositionController(robot_name, robot_component, pos_limits_lower, pos_limits_upper)
